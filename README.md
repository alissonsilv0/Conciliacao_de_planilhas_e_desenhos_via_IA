...
> 
> `![Print da Interface Web](./docs/prints/frontend-upload.png)`
> *(📍 **Local para colocar o print da tela de envio do PDF**)*
...
> 
> `![Print do Fluxo no Make](./docs/prints/make-scenario.png)`
> *(📍 **Local para colocar o print do cenário completo do Make com os 6 módulos**)*
...
> 
> `![Print do Resultado](./docs/prints/result-dashboard.png)`
> *(📍 **Local para colocar o print do relatório de divergências / JSON exibido**)*
...
| **Inteligência Artificial** | **Google AI Studio (Gemini 3.1 Flash)** | Leitura ótica/contextual de documentos e cruzamento lógico de engenharia. |
